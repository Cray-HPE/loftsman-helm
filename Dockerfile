...
# install
##########################
FROM artifactory.algol60.net/csm-docker/stable/docker-kubectl:${loftsman_docker_kubectl_image_version} as install
...
# helm
##########################
FROM artifactory.algol60.net/csm-docker/stable/docker-kubectl:${loftsman_docker_kubectl_image_version} as helm
